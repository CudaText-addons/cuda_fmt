...
- Format: Runs formatter for current editor file. If more than one formatters found (for example, JS lexer has 3+ formatters), menu dialog will suggest to choose one of them.
...
To see how to write formatters, install "Formatters for JavaScript" which has most of formatter features.
